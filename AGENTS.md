...
```
[ ] 00  Setup: BaseLayout + tokens en global.css + fuentes (Manrope/JetBrains Mono)
[ ] 01  Navbar (sticky + CTA)
[ ] 02  Hero (titular + CTAs + visual blueprint)
[ ] 03  StackStrip (marquee CSS)
[ ] 04  ProblemSolution (3 dolores → 3 soluciones)
[ ] 05  Services (Bento Grid ×3)
[ ] 06  ProofOfWork (3 tarjetas con C4 + métricas + links)
[ ] 07  Process (4 pasos)
